...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_whatwg_fetch__ = __webpack_require__(334);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__js_OscappsAccordion__ = __webpack_require__(335);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__scss_styles_scss__ = __webpack_require__(337);
...
document.addEventListener('DOMContentLoaded', () => {
  ...
  for (let OscappsAccordionElement of OscappsAccordionElements) {
    instance.push(new __WEBPACK_IMPORTED_MODULE_2__js_OscappsAccordion__["a" /* default */](OscappsAccordionElement))
  }
})

/* harmony default export */ __webpack_exports__["default"] = (__WEBPACK_IMPORTED_MODULE_2__js_OscappsAccordion__["a" /* default */]);
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__lib_DomLib__ = __webpack_require__(336);
...
class OscappsAccordion {
  ...
  constructor (element, {
    ...
    this.multipleSelection = multipleSelection || __WEBPACK_IMPORTED_MODULE_0__lib_DomLib__["a" /* default */].hasClass(element, MULTIPLE_SELECTION_CLASS_NAME)
    this.onOpen = onOpen
    ...
    if (!__WEBPACK_IMPORTED_MODULE_0__lib_DomLib__["a" /* default */].hasClass(this.OscappsAccordionElement, DEFAULT_OSCAPPS_ACCORDION_CLASS_NAME)) {
      __WEBPACK_IMPORTED_MODULE_0__lib_DomLib__["a" /* default */].addClass(this.OscappsAccordionElement, DEFAULT_OSCAPPS_ACCORDION_CLASS_NAME)
    }
  ...
  _hideArrowIcon () {
    ...
    for (let sectionHeader of sectionsHeader) {
      __WEBPACK_IMPORTED_MODULE_0__lib_DomLib__["a" /* default */].addClass(sectionHeader, HIDE_ICON_CLASS_NAME)
    }
  }
  ...
  _initActiveSections () {
    ...
    for (const [index, activeSection] of activeSections.entries()) {
      if (this.multipleSelection || index === 0) {
        ...
        __WEBPACK_IMPORTED_MODULE_0__lib_DomLib__["a" /* default */].removeClass(activeSection, ACTIVE_CLASS_NAME)
      }
    }
  }
   ...
   */
  _toggle (element) {
    if (__WEBPACK_IMPORTED_MODULE_0__lib_DomLib__["a" /* default */].hasClass(element, ACTIVE_CLASS_NAME)) {
  ...
  _hideSection (element) {
    __WEBPACK_IMPORTED_MODULE_0__lib_DomLib__["a" /* default */].removeClass(element, ACTIVE_CLASS_NAME)
  ...
  */
  _showSection (element) {
    ...
    __WEBPACK_IMPORTED_MODULE_0__lib_DomLib__["a" /* default */].addClass(element, ACTIVE_CLASS_NAME)
  ...
  _hideOtherActiveSection () {
    ...
    if (activeElement) {
      __WEBPACK_IMPORTED_MODULE_0__lib_DomLib__["a" /* default */].removeClass(activeElement, ACTIVE_CLASS_NAME)
...
/* harmony default export */ __webpack_exports__["a"] = (OscappsAccordion);
...
/* harmony default export */ __webpack_exports__["a"] = (DomLib);
